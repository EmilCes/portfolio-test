      ...
      >
        ...
        >
          <label className="flex flex-col">
            <span className="text-white font-medium mb-4">Yourn Name</span>
            <input
              type="text"
              name="name"
              value={form.name}
          ...
          <label className="flex flex-col">
            <span className="text-white font-medium mb-4">Yourn Email</span>
            <input
              type="email"
              name="email"
              value={form.email}
          ...
          <label className="flex flex-col">
            <span className="text-white font-medium mb-4">Yourn Message</span>
            <textarea
              rows="7"
              name="message"
              value={form.message}
